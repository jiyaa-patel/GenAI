...
const Chatbot = () => {
  ...
  useEffect(() => {
    ...
    // Only load sessions if authenticated and not already loaded
    if (!isLoadingSessions && !sessionsLoadedRef.current) {
  ...
  const loadSessions = async () => {
    if (isLoadingSessions) {
      console.log('Sessions already loading, skipping...');
      return;
    }
  ...
  // Remove duplicate useEffect - sessions are loaded in auth check above
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="p-2 rounded-lg text-foreground/70 hover:bg-border transition-colors disabled:opacity-50"
              ...
              {isLoadingSessions ? (
                <div className="p-3 text-center text-foreground/60 text-sm">
                  <div className="flex flex-col items-center space-y-2">
                    <div className="w-6 h-6 rounded-full border-2 border-border border-t-blue-500 animate-spin"></div>
                    <span>Please wait, loading your previous sessions...</span>
                  </div>
                </div>
          ...
          <div className="p-4 border-t border-border">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="p-2 rounded-lg text-foreground/70 hover:bg-red-100 hover:text-red-600 transition-colors"
                title="Logout"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
